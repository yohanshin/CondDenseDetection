...
class HumanPoseEstimationDataset(Dataset):
    ...
    def __init__(self, is_train=True, image_width=288, image_height=384,
                 ...
                 flip_pairs=None, joints_weight=None, cond_mask_prob=0.3, ldmk_prompt_prob=0.0, ldmk_prompt_ratio=0.0,
                 **kwargs):
        ...
        self.ldmk_prompt_prob = ldmk_prompt_prob
        self.ldmk_prompt_ratio = ldmk_prompt_ratio
